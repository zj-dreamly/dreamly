 ...
 */
@Slf4j
public class EmailParsingHelper {
	 ...
	 */
	public static void receive(String emailAdress, String password) throws Exception {

		// 端口号
		String port = "110";
		// 服务器地址
		String servicePath = "pop.163.com";
		...
		store.connect(emailAdress, password);
	...
	public static void parseMessage(Message... messages) throws MessagingException, IOException {
		...
		for (int i = 0, count = messages.length; i < count; i++) {
			...
			log.info("【开始解析第" + msg.getMessageNumber() + "封邮件】");
	 ...
	 */
	public static void saveFile(InputStream is, String destDir, String fileName) throws FileNotFoundException, IOException {
