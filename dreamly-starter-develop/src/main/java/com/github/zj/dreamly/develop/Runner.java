...
public class Runner {
	 ...
	 * 代码生成的模块名
	 */
	private static final String CODE_NAME = "market";
	/**
	 * 代码所在服务名
	 */
	 ...
	 * 代码生成的包名
	 */
	private static final String PACKAGE_NAME = "com.synco.kavo";
	/**
	 * 需要去掉的表前缀
	 */
	 ...
	 * 需要生成的表名(两者只能取其一)
	 */
	private static final String[] INCLUDE_TABLES = {"mp_article"};
	/**
	 * 需要排除的表名(两者只能取其一)
	 */
